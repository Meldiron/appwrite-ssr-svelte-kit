				...
				<section class="drop-section">
					<ul class="drop-list">
						<li class="drop-list-item">
							<a class="drop-button u-cross-center is-selected" href="https://svelte-kit.ssr.almostapps.eu/">
						...
						<li class="drop-list-item">
							<a class="drop-button u-cross-center" href="https://next-js.ssr.almostapps.eu/">
								<svg role="img" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
									><title>Next.js</title><path
                    ...
                    >
                      ...
                      >
                        <path
                          d="M140.301 163.741L110.951 134.541L110.531 134.611L116.001 130.201L48.1213 72.5711L63.5313 57.7211L54.0013 2.20117L11.5813 58.9911C4.30128 66.3511 2.90128 78.3811 8.18128 87.2011L34.9813 131.691C39.0813 138.511 45.5213 142.891 54.5113 142.571C73.5413 141.901 81.9113 141.901 81.9113 141.901L140.281 163.711L140.301 163.731V163.741Z"
                          fill="currentColor"
                        />
                        <path
                          d="M154.801 81.9212C159.031 73.2012 160.541 65.5712 156.371 57.9212L150.441 47.0012L147.361 41.4012L146.161 39.2012L146.061 39.3412L129.911 11.3412C127.915 7.86085 125.028 4.97549 121.546 2.98228C118.064 0.989063 114.113 -0.0399603 110.101 0.00118734L95.9413 0.401189L53.6913 0.511188C49.7687 0.539401 45.9206 1.58541 42.5236 3.54688C39.1265 5.50835 36.2968 8.31809 34.3113 11.7012L8.6413 62.6812L54.5813 5.53119L114.851 71.8012L104.051 82.7312L110.501 134.571L110.591 134.471V134.611H110.491L110.631 134.741L115.651 139.641L139.951 163.381C140.981 164.361 142.631 163.181 141.951 161.961L126.931 132.391"
                          fill="currentColor"
                        />
                      </svg>

                      <span class="text">Qwik</span>
                    </a>
                  </li>

						<li class="drop-list-item">
							<a class="drop-button u-cross-center" href="https://nuxt.ssr.almostapps.eu/">
								<svg role="img" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
									><title>Nuxt.js</title><path
